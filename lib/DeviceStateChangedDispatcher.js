...
class DeviceStateChangeDispatcher
{
	...
	async reregisterDeviceCapabilities()
	{
		...
		for (const key of this.listeners.keys())
		{
            ...
            if (!parsed)
            {
                this.app.updateLog(`reregisterDeviceCapabilities: invalid listener key ${key}`, 0);
                continue;
            }
		...
		{
            await this.registerDeviceCapability(deviceCapability.deviceId, deviceCapability.capabilityId);
		}
	}
