...
1. One touch control for your most important devices and scenes.
2. Quick visual feedback with custom labels, status text, and live display values.
3. A cleaner wall mounted smart home experience without digging through menus.
4. Flexible layouts for buttons, displays, and grouped panels.
5. Faster daily use for routines such as lighting, climate, security, and media.
6. A modern, customizable look that blends into your home and hardware setup.
...
6. Enter a Top Label if you want one. This is displayed in green on the button display.
7. Enter a Label. This is shown in white and in a larger font on the button display, just below the Top Text.
8. Repeat the steps for the Right button bar.
9. Click the Save Configurations button.
...
3. Click New Display Item.
4. Select a Device.
5. Select a Capability.
6. Edit the Label if required.
7. Edit the Units if required. This is text only and does not change the values sent to the display.
8. Enter the X and Y positions. These are percentages of the display width and height.
9. Enter a width. This is again a percentage of the display width.
10. Enter a Rounding value. 0 means whole numbers, 1 means 1 decimal place, and so on.
11. Select a Font Size from the list.
12. Add more display items as required.
13. Click Save Configurations.
...
1. one display configuration.
2. one or more button bar / connector configurations.
3. a custom name for the panel.
...
5. Assign one or more connector or button configurations to the group.
...
7. You can click the buttons in the mini displays to toggle the capability in Homey.
